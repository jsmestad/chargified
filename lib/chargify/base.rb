module RSpreedly
  ...
  class Base
    ...
    def initialize
      self.class.base_uri "https://#{Chargify::Config.subdomain}.chargify.com"
      self.class.basic_auth Chargify::Config.api_key, 'x'
    end
    ...
    def self.api_request(type, path, options={})
      ...
      options.merge!({
        :basic_auth => {:username => Chargify::Config.api_key, :password => 'X'},
